...
You Develop two Knacks for every odd-numbered level you reach and one Knack for every even-numbered level.

Some Knacks May be Developed more than once but only once per level. Some Knacks require other Prerequisite Knacks.

Anyone may develop Basic Knacks but you must reach Level 5 to develop Expert Knacks and Level 10 to develop Master Knacks.
...
Developing this Knack allows you to memorize a single spell per day from any of the magical traditions that you are versed in.

## Combat Capabilities

### Agility
Effect: +1 AC when unarmored. 
Note: CanMay be taken once per level.
Level: Basic
...
### Friend to Animals
Effect: Like the spell, but better. 
Level: Basic
