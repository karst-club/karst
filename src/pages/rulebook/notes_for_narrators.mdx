...
The narrator makes the world of Karst come alive. It may be the players whose characters are central to the plot, but it is the narrator who facilitates the story itself. If this is the role you are playing, you have a greater responsibility – and a potentially greater reward. This chapter aims to give you a few tips and tricks for handling these responsibilities while having an enjoyable time in the process.
